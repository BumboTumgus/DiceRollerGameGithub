...
{
    public enum BuffType { None, Strength, Thorns, Weaken, Stun, Bleed, Luck, Sunder, RerollAttack, RerollDefense, Brace, Regen, Tenacity, Vamperism, Evade,
    Anoint, Omniscience, Wither, Still, Shackle, Whisper};
